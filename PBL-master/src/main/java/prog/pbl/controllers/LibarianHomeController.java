...
public class LibarianHomeController implements Initializable{

    static LibarianHomeController libarianHomeController;
    ...
    public void refreshScreen() {
        mainWindow.refreshMainWindow("/prog/pbl/LibrarianHomePage.fxml");
